...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.player_index = 0
        self.player_jump = pygame.image.load('00_tutorial_clearcode/graphics/player/jump.png').convert_alpha()

        self.image = self.player_walk[self.player_index] 
        self.rect = self.image.get_rect(midbottom=(80,300))
        self.gravity = 0

        self.jump_sound = pygame.mixer.Sound('00_tutorial_clearcode/audio/jump.mp3')
...
score = 0
bg_music = pygame.mixer.Sound('00_tutorial_clearcode/audio/music.wav')
